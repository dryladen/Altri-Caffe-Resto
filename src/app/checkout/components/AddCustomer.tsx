...
const AddCustomer = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col mt-4 p-4">
        ...
        <div className="flex flex-col py-8">
          ...
          <Input
            ...
            className="mt-3 text-md focus-visible:ring-1 focus-visible:ring-amber-600 focus-visible:ring-offset-0"
            value={name}
          ...
          <div className="flex mt-3 focus-within:ring-1 focus-within:ring-amber-600 rounded-md">
      ...
      <Separator className="h-4 bg-gray-100" />
      <Button
        className="flex rounded-full fixed py-[10px] right-4 left-4 bottom-4 shadow-md h-fit bg-amber-600 z- hover:bg-gray-400"
        variant={"default"}
